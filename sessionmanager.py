...
from constants import BLACK, DESTROY_ENEMIES, DOWN, GREEN, HEALING, POWER_UP, REPAIR_FORTRESS, SHIELD, UP, WHITE, SCORE, SPEED, WIN, LOOSE, scale, screen_size
...
class SessionManager:
    ...
    def create_by_sign(self, s, point):
        ...
        if s == 'R':
            return self.create_bonus(point, SPEED)
